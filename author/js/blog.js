...
const blogPosts = [
  {
    ...
    excerpt:
      "A ansiedade faz parte da vida, mas quando ela se torna constante e interfere no seu dia a dia, é hora de agir. Confira estratégias simples e eficazes.",
    date: "2026-02-05",
    readTime: "5 min",
  ...
  },
  {
    ...
    excerpt:
      "Muitas pessoas ainda têm dúvidas sobre como funciona a terapia e se ela é realmente para elas. Vamos esclarecer os principais mitos.",
    date: "2026-01-28",
    readTime: "6 min",
  ...
  },
  {
    ...
    excerpt:
      "A autoestima não é algo que nasce pronto. É uma construção diária que envolve autoconhecimento, autocompaixão e ação.",
    date: "2026-01-20",
    readTime: "7 min",
    url: "#",
    image: null,
  },
  {
    ...
    excerpt:
      "O esgotamento profissional é mais comum do que imaginamos. Aprenda a identificar os sinais e o que fazer para recuperar seu bem-estar.",
    date: "2026-01-12",
    readTime: "6 min",
    url: "#",
    image: null,
  },
  {
    ...
    excerpt:
      "O atendimento psicológico online é tão eficaz quanto o presencial? Tire suas dúvidas sobre essa modalidade que vem crescendo no Brasil.",
    date: "2026-01-05",
    readTime: "5 min",
    url: "#",
    image: null,
  },
  {
    ...
    excerpt:
      "Nem sempre é fácil reconhecer quando um relacionamento está fazendo mais mal do que bem. Entenda os sinais e como agir.",
    date: "2025-12-28",
    readTime: "8 min",
    url: "#",
    image: null,
